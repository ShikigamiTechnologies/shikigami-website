...
const required = [
  ...
  ["staging provider gate", worker.includes("This provider-backed API is disabled in public staging")],
  ["staging Cypher API remains testable", !worker.includes('path.startsWith("/api/")')],
  ["Cypher Online positioning", cypher.includes("Tenant-isolated document intelligence")],
  ["Cypher human approval boundary", cypher.includes("gives authorized people the final decision")],
